...
<Card>
  ...
  <CardFooter>Footer</CardFooter>
		...
		examples: [
			...
			{ title: "Generative card (3P)", description: "Generative card with 3P source logo and content type icon.", demoSlug: "card-demo-generative-card" },
			{ title: "Generative card (1P)", description: "Generative card with Atlassian product logo and content type icon.", demoSlug: "card-demo-generative-card-1p" },
			{ title: "Generative card (icon)", description: "Generative card with icon tile and content type icon.", demoSlug: "card-demo-generative-card-icon" },
