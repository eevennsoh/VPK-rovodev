  ...
  <ProgressValue />
		...
		props: [
			{ name: "value", type: "number", description: "Current progress value (0-100)." },
			{
				...
				default: '"default"',
				description: "Visual variant. Default uses neutral bold, success uses green, inverse uses white, transparent hides the track.",
			},
			{ name: "isIndeterminate", type: "boolean", default: "false", description: "Show indeterminate sliding animation." },
		],
		subComponents: [
		...
		examples: [
			...
			{ title: "Indeterminate", description: "Sliding animation for unknown progress.", demoSlug: "progress-demo-indeterminate" },
