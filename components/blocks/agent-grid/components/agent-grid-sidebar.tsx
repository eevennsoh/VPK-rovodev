...
interface AgentGridSidebarProps extends React.ComponentProps<typeof Sidebar> {
	isOverlay?: boolean;
	onPinSidebar?: () => void;
}

export function AgentGridSidebar({ isOverlay, onPinSidebar, ...props }: Readonly<AgentGridSidebarProps>) {
