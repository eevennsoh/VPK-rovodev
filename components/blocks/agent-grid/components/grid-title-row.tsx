...
export default function GridTitleRow({ title, onNewChat, sidebarOpen, sidebarHovered, onExpandSidebar, onHoverEnter, onHoverLeave }: Readonly<GridTitleRowProps>) {
	return (
		<div className="flex h-14 items-center justify-between border-b border-border px-4">
			...
			<div className="min-w-0 flex-1">
				...
				<p className="text-xs text-text-subtlest">Live execution view</p>
			</div>
