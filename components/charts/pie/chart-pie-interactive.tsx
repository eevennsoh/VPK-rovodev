	...
	return (
		<Card data-chart={id} className="flex flex-col h-full">
			...
			<CardHeader className="flex-row items-start space-y-0 pb-0">
				...
				<Select value={activeMonth} onValueChange={(value) => { if (value) setActiveMonth(value); }}>
			...
			<CardContent className="flex flex-1 justify-center pb-0">
				<ChartContainer id={id} config={chartConfig} className="mx-auto aspect-square w-full max-w-[300px]">
					<PieChart>
						<ChartTooltip cursor={false} defaultIndex={activeIndex} content={<ChartTooltipContent hideLabel />} />
						<Pie
							data={desktopData}
							dataKey="desktop"
							nameKey="month"
