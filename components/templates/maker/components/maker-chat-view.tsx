...
import { getPlanModeCopy } from "@/components/templates/maker/lib/maker-copy";
...
import MakerComposer from "./maker-composer";
import { MakerCardWidgetInline } from "./maker-card-widget-inline";
...
function BottomOverlay({
	...
	if (!hasPendingResponseCard) {
		return <MakerComposer {...composerProps} />;
	}
...
export default function MakerChatView() {
	const {
		prompt,
		isPlanMode,
		isStreaming,
