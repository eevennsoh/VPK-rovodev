...
interface AnimatedRovoShapeProps {
  size?: number;
  className?: string;
}
...
export function AnimatedRovoShape({
  ...
  return (
    ...
    >
      <defs>
        {/* Create a mask using the exact silhouette of all paths combined */}
        <clipPath id={maskId}>
          <path d={path1} />
          <path d={path2} />
          <path d={path3} />
