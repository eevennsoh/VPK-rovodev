...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      ...
      from === "user" ? "is-user ml-auto max-w-full justify-end" : "is-assistant",
      className
    )}
    {...props}
  />
...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:w-full group-[.is-user]:max-w-full group-[.is-user]:rounded-xl group-[.is-user]:rounded-br-sm group-[.is-user]:bg-primary group-[.is-user]:px-3 group-[.is-user]:py-2 group-[.is-user]:text-primary-foreground",
